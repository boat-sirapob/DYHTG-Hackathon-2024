...
router.post('/submit-song-form', async (req, res) => {
    try {
...
router.post('/submit-chords-form', async (req, res) => {
    try {
        ...
        console.log(req.body);
        let recommendation_res = await AIController.generateChords(req, res);
